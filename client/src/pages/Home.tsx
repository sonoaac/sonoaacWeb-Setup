      ...
      <section className="px-6 py-20 md:py-36 border-b border-green-900/30 min-h-[80vh] flex items-center">
        <div className="max-w-4xl mx-auto w-full">
          ...
          >
            ...
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-green-100 leading-tight mb-6">
              Fast. Reliable.<br />
              Tech Support<br />
              <span className="text-green-400">On Your Terms.</span>
            </h1>
            <p className="text-green-600 text-base md:text-lg leading-relaxed max-w-xl mb-10">
      ...
      <section className="px-6 py-16 md:py-24 border-b border-green-900/30">
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeUp}>
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-green-100 mb-12">
              What We Do
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-green-900/20">
            {services.map((service, i) => (
              ...
              >
                ...
                <h3 className="text-sm font-bold text-green-300 uppercase tracking-[0.15em] mb-3 group-hover:text-green-400 transition-colors">
                  {service.title}
                </h3>
          ...
          <motion.div {...fadeUp}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="border-l-2 border-green-800 pl-6">
                ...
                <p className="text-green-600 text-sm leading-relaxed mb-3">
                ...
                <Link href="/it-support">
                  <button className="text-xs text-green-700 uppercase tracking-[0.15em] hover:text-green-400 transition-colors">
                    Learn more —
                  </button>
                </Link>
              </div>
      ...
      <section className="px-6 py-20 md:py-32">
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeUp}>
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-green-100 mb-6">
              Ready for reliable<br />tech support?
            </h2>
            <p className="text-green-600 text-base mb-10 max-w-md">
